...
public class ItemAsunas_Armor extends ItemArmor{

	public ItemAsunas_Armor(int renderIndexIn, EntityEquipmentSlot equipmentSlotIn) {
		super(MArmorMaterials.SAOLEATHER, renderIndexIn, equipmentSlotIn);
